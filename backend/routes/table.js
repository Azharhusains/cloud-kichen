...
const { getTables, getTable, createTable, updateTable, deleteTable, updateTableStatus, lockTable, unlockTable } = require('../controllers/tableController');
...
router.post('/:tableNumber/unlock', protect, unlockTable);
